      ...
      <div className="py-16 px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-start mx-auto w-[95%]">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center cursor-pointer hover:bg-white/20 transition">
              <HiArrowUpRight onClick={()=>router.push("/about-us")} className="text-white text-sm" />
            </span>
          </div>
        ...
        >
          <h2 className="text-white text-2xl md:text-3xl font-bold leading-snug">
            An Integrated System For Managing And Following Up On Cases Step By
            Step With Complete Professionalism.
          </h2>
          <div>
          ...
          <div>
            <p className="text-white text-xl font-bold leading-snug">
              All The Details Of Your Case In One Place...
              <br />
          ...
          <motion.button
            ...
            className="flex items-center cursor-pointer gap-2 bg-[#E8C547] text-black text-sm font-bold px-5 py-3 rounded-full w-fit"
          >
            Explore Now
