...
const CaseManagement = () => {
  ...
  const CASE_STATS = [
    {
      label: "Total Cases",
      value: CaseDataOverFlow?.totalCases || 0,
      icon: Folder,
      change: "0%",
      dark: true,
    },
    {
      label: "Pending",
      value: CaseDataOverFlow?.pendingCases || 0,
      icon: Clock,
      change: "0%",
      dark: false,
    },
    {
      label: "Active",
      value: CaseDataOverFlow?.activeCases || 0,
      icon: Activity,
      change: "0%",
      dark: false,
    },
    {
      label: "Closed",
      value: CaseDataOverFlow?.closedCases || 0,
      icon: Shield,
      change: "0%",
      dark: false,
    },
  ...
  const getItems = (row, actions) => [
    {
      ...
      action: () => {
        router.push(`/admin-dashboard/case-management/${row.id}`);
        actions.closeMenu();
      },
    },
